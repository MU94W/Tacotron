...
from Tacotron.Modules import ConvNetNOBN, HighwayNet

bidirectional_dynamic_rnn = tf.nn.bidirectional_dynamic_rnn

Conv1dBankWithMaxPool   = ConvNetNOBN.Conv1dBankWithMaxPool
Conv1dProjection        = ConvNetNOBN.Conv1dProjection
